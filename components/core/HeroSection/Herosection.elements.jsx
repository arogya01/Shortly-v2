...
import { padding , layout , border , typography} from "styled-system";
...
export const HeroHeadlineWrapper = styled.section`
  display: flex;
...
export const HeroImg = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="620" height="482">
      <defs>
